        ...
        {scheduleMeeting.length == 0 ? <><b>No Scheduled Meeting</b></> : <div className="updateCourseCard">
          {
            scheduleMeeting.map((elem, index) => {
              ...
              const meetingaccess = `http://localhost:3000/?id=-${elem.courseT.replaceAll(' ', '')}&ref=admin&name=${access}`
              return (
                <>
                  <div className="cardRow">
                    ...
                    <div className="rightSide" style={{ width: "15%" }}>
                      <div className="editBTN" style={{ fontWeight: "800", fontSize: "1.1rem" }}> <a style={{ textDecoration: "none", color: "black" }} href={meetingaccess} target="_blank" rel="noopener noreferrer">Join Now</a> </div>
